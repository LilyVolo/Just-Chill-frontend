		...
		<div className="container-container-plan-page">
			...
			<div className="wrapper-container-plan-page">
				<div className="plan-block">
					...
					<p>
						We propose you to visit <br /> {data.infos[0][0].name} to make yor
						body relaxed:
					</p>
				...
				<div className="plan-block">
					...
					<p>
						According to your choice we recommended you <br />{" "}
						{data.infos[1][0].name}
					</p>
					<p> rating of the place: {data.infos[1][0].rating} </p>
					<p>address: {data.infos[1][0].formatted_address}</p>
					<p>
						We will organize transfer, and dégustation will be prepared
						according to our planing
					</p>
				</div>
				<div className="plan-block">
