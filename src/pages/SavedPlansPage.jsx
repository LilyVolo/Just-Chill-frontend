...
console.log(plans)
  ...
  if (!plans) {
    ...
    <p>adress: {plan.places[0].formatted_address}</p>
               ...
               <div>
               <img src="" alt="" />
                <p>We propose you to visit {plan.places[1].name} to make yor body relaxed:</p>
    <p> rating of the place: {plan.places[1].rating} </p>
    <p>adress: {plan.places[1].formatted_address}</p>
               </div>
              <div>
              <img src="" alt="" />
