...
function CityPage() {
	...
	return (
			...
			>
				{city.slimg.map((el) => {
					return (
						<SwiperSlide key={el}>
							<img
								className="img_places"
								src={`${city.name.toLowerCase()}/${el}`}
								alt=""
							/>
						</SwiperSlide>
						// {`../public/${city.img2}`}
			...
			<div className="form-container">
				<form action="" onSubmit={handleSubmit} className="form-wrapper">
					<div className="firs-block block">
						...
						<img className="img_places" src={city.img2.toLowerCase()} alt="" />
					</div>

					<div className="second-block block">
						<img className="img_places" src={city.img3.toLowerCase()} alt="" />
					...
					<div className="third-block block">
						<div className="small-box">
							<p className="selector-option-third">
								{" "}
								Indicate what cuisine you prefer{" "}
							</p>
        ...
        /> */}
						...
						<img
							className="paris4 img_places"
							src={city.img4.toLowerCase()}
							alt=""
						/>
					</div>
